<div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset($sliders['0']->image) }}" style="height: 400px" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="text-white"><span class="text-white">{{ $sliders['0']->title }}</h1>
                    <p class="text-white">{{ $sliders['0']->description }}</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset($sliders['1']->image) }}" style="height: 400px" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>{{ $sliders['1']->title }}</h5>
                    <p>{{ $sliders['1']->description }}</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset($sliders['2']->image) }}" style="height: 400px" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>{{ $sliders['2']->title }}</h5>
    ...
    <div class="product-area most-popular section" style="padding:50px 0 !important">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                                            ...
                                            <div class="product-action">
                                                <a data-product-slug={{ $product->slug }}
                                                    ...
                                                    data-target="#quickViewModal" title="Quick View"><i
                                                        ...
                                                        Shop</span></a>
                                                <a wire:click="addToWishList({{ $product->id }})"
                                                    title="Wishlist"><i class="fa-regular fa-heart"></i><span>Add to
                                                        Wishlist</span></a>
